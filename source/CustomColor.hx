...
/**
 * THIS IS RIPPED FROM PSYCH ENGINE LMAO
 * SHADOW MARIO IS SWAG
 */
class CustomColor {
	public var shader(default, null):CustomColorShader = new CustomColorShader();
...
class CustomColorShader extends FlxShader {
	@:glFragmentSource('
