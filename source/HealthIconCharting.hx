...
class HealthIconCharting extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('bf-car-night', [0, 1, 2], 0, false, isPlayer);
		...
		animation.add('pico-speaker', [27, 28, 29], 0, false, isPlayer);
		animation.add('mom', [16, 17, 18], 0, false, isPlayer);
		animation.add('mom-car', [16, 17, 18], 0, false, isPlayer);
		animation.add('mom-car-night', [16, 17, 18], 0, false, isPlayer);
		...
		animation.add('gf-christmas', [13, 14, 15], 0, false, isPlayer);
		animation.add('gf-pixel', [13, 14, 15], 0, false, isPlayer);
		animation.add('gf-car', [13, 14, 15], 0, false, isPlayer);
		animation.add('gf-steps', [13, 14, 15], 0, false, isPlayer);
		animation.add('gf-car-night', [13, 14, 15], 0, false, isPlayer);
